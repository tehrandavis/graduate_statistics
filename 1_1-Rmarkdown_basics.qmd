...
are but a few that you may encounter. An expanded list can be found [here](https://www.rstudio.com/wp-content/uploads/2016/03/rmarkdown-cheatsheet-2.0.pdf). Which, by the way, is how you embed weblinks. Heck you can even do mathematical equations. For example, here is the binomial probability.
